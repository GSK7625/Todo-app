...
const TodoInput: React.FC<TodoInputProps> = ({ onAddTodo }) => {
  ...
  const unitButtonClass = (unit: 'minutes' | 'hours') => {
    ...
    return `${base} bg-slate-100 dark:bg-slate-800 text-slate-500 border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700`;
  }
  ...
  const inputStyles = "w-full p-2 bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200 text-slate-800 dark:text-slate-200";
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6">
      <div className="flex gap-2">
        <input
          ...
          className="flex-grow p-3 bg-slate-100 dark:bg-slate-800 border-transparent rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200 text-slate-800 dark:text-slate-100 placeholder-slate-500"
        />
        <button
          type="submit"
          className="bg-indigo-600 text-white p-3 rounded-lg shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-900 transition duration-200 flex items-center justify-center"
        ...
        <div>
            ...
            <div className="flex">
                <input
                  ...
                  min="0"
                  className="w-full p-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-l-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200 text-slate-800 dark:text-slate-200 z-10"
                />
      ...
      <div className="border-t border-slate-200 dark:border-slate-800 pt-4">
        <div className="flex justify-between items-center mb-2">
            ...
            {totalDurationInMinutes > 0 && (
                <div className={`text-xs font-mono p-1 px-2 rounded-full ${remainingDuration < 0 ? 'bg-red-200 text-red-800 dark:bg-red-900 dark:text-red-200' : 'bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300'}`}>
        ...
        <div className="space-y-2 max-h-32 overflow-y-auto pr-2 mb-2">
            ...
            <div key={index} className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800/70 p-2 rounded-md animate-fade-in">
        ...
        <div className="flex gap-2">
            <input
                ...
                className="flex-grow py-1 px-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200 text-sm text-slate-800 dark:text-slate-200"
            />
            <input
                type="number"
                ...
                placeholder="min"
                min="0"
                className="w-16 py-1 px-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200 text-sm text-slate-800 dark:text-slate-200"
            ...
            <button
                ...
                className="bg-yellow-400 text-yellow-900 p-2 rounded-lg shadow-sm hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
